...
setup(name='mercurio-button',
      version='0.1',
      description='Transmits messages between the Microcontroller box and this listener',
      long_description='Transmit messages between Microcontroller and this listener',
